...
{{--    </div>--}}
    <div class="container">
        <div id="content" class="space-top-none">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <h2>Phiếu tiếp nhận thông tin</h2>
                    <div class="space20">&nbsp;</div>
                    <p>Mọi ý kiến thắc mắc, đóng góp của khách hàng vui lòng điền vào phiếu dưới đây!</p>
                    <div class="space20">&nbsp;</div>
                    <form action="#" method="post" class="contact-form">
                        <div class="form-block">
                            <input name="your-name" type="text" placeholder="Nhập tên của bạn (bắt buộc)" value="{{auth('customers')->user()}}">
                        </div>
                        <div class="form-block">
                            <input name="your-email" type="email" placeholder="Nhập địa chỉ email của bạn (bắt buộc)">
                        </div>
                        <div class="form-block">
                            <input name="your-subject" type="text" placeholder="Nhập tiêu đề của phiếu (bắt buộc)">
                        </div>
                        <div class="form-block">
                            <textarea name="your-message" placeholder="Nội dung tin"></textarea>
                        </div>
                        <div class="form-block">
                ...
                <div class="col-sm-4">
                    ...
                    <p>
                        Ngách 26/154, ngõ 154 Đình Thôn, phường Mỹ Đình 1, quận Nam Từ Liêm <br>
                        Hà Nội
                    </p>
                    <div class="space20">&nbsp;</div>
