    ...
    <div class="content-wrapper">
        ...
        <div class="row grid-margin">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="text-align: center;font-size: 30px;">Add Product</h4>
                        <form class="forms-sample" method="post" action="admin/products/add_product" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            <div class="form-group">
                                <label for="exampleInputPassword4">Product belongs to category<span style="color: red">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="" name="name" placeholder="Input product name">
                            </div>
...
{{--                            </div>--}}
                            {{--                                End multiple Image--}}
                            <div class="form-group">
                                <label for="exampleInputPassword4">Manufacture<span style="color: red">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputName1">Selling price (Unit: VND)<span style="color: red">*</span></label>
                                <input type="number" class="form-control" min="1" max="1000000000" value="" name="selling_price" id="exampleInputName1" placeholder="Input selling price of product">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputName1">Promoted price (Unit: VND) <span style="color: red">*</span></label>
                                <div style="display: flex;justify-content: center">
                                    <input type="number" min="0" class="form-control" value="" name="promoted_price" id="exampleInputName1" placeholder="Input promoted price of product">
                                </div>
                            </div>
                            ...
                            <input type="submit" class="btn btn-primary mr-2" name="submit" value="Add product">
                        </form>
                    </div>
                </div>
            </div>
